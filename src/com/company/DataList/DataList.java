...
public class DataList<E> implements List<E> {
    private int size;
    ...
    DataList(int elementCount) {
        this.dataList = new Object[elementCount];
    }
    ...
    public boolean contains(Object o) {
        if (o == null) {
            for (int i = 0; i < size; i++) {
                if (dataList[i] == null) return true;
            }
        } else {
            for (int i = 0; i < size; i++) {
                if (dataList[i].equals(o)) return true;
            }
        }
        return false;
    }
    ...
    private void add(E e, E[] data) {
        size++;
        data = (E[]) dataList;
        dataList = new Object[size];
        dataList = Arrays.copyOf(data, size);
        dataList[size - 1] = e;
    }
    ...
    public void add(int index, E element) {
        add(element, (E[]) dataList);
        for (int i = dataList.length - 2; i >= index; i--) {
    ...
    public E remove(int index) {
        ...
        dataList = Arrays.copyOf(dataList, size - 1);
        size--;
        return (E) dataList[index];
    }
    ...
    public int indexOf(Object o) {
        if (o == null) {
            for (int i = 0; i < size; i++) {
                if (dataList[i] == null) return i;
            }
        } else {
            for (int i = 0; i < size; i++) {
                if (dataList[i].equals(o)) return i;
            }
        }
        return -1;
    }
